...
**parameter options**：
```
Usage: ./start.sh <nodes_number> [delay_between_nodes_in_seconds] [txn_gen_count] [txn_bytes] [band_width] [node_specific_bandwidths]
```
**parameter settings**：  
...
* `node_specific_bandwidths`: specify network bandwidth for specific nodes.
